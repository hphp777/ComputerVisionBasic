- Purpose of this code
 This is the simplest low-pass filte for RGB image. This algorithm makes image blurry than the original. 
 As the filter size increases, the image become more blurry.

- How to run this code
 Through the Visual Studio, Load "MeanFilterRGB.cpp" and run this code with input image"lena.jpg".
