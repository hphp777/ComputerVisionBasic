- Purpose of this code
 This code is made to make gray scale image sharper by boosting high-frequency components.
...
- How to define default parameters
 ...
 Mat input: Give original image which will be manipulated.
 Mat A_G: Give image on which Gaussian filter was applied. (Blured image)
 float k: Arbitrary parameter to scale overall intensity of image on which low-pass filtering was applied. It is a value between 0.0-1.0. In this code, I gave 0.4.