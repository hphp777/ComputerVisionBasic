- Purpose of this code
 This code is made to blur input RGB image through Gaussian filter. It is one of the low pass filterings.
 In this code, Gaussian Filter does not applied seperately.
