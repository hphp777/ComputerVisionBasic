...
int main() {
	...
	fopen_s(&f_PDF, "hist_strtching_PDF.txt", "w+");
	fopen_s(&f_stretched_PDF, "hist_strtching_stretched_PDF.txt", "w+");
	fopen_s(&f_trans_func_stretch, "hist_strtching_trans_func_stretch.txt", "w+");
	...
	imshow("Original Image", drawHist_gray_PDF(input_gray));
	namedWindow("Stretched Image", WINDOW_AUTOSIZE);
	imshow("Stretched Image", drawHist_gray_PDF(stretched));
